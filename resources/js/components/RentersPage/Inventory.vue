<template>
    <div class="container">
      ...
      <section v-if="$gate.isRenter()">
        <div class="row justify-content-center" >
             <form @submit.prevent="searchInventory" class="form-inline float-sm-right" style="width:100%">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mt-2" v-for="item in inventory.data" :key="item.id ">
                    <div class="card-body" style="padding:15px;border-left:4px solid #2c3e50">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                            <label>Cube #:</label> {{item.box_number}}
                          </div>
                            <div class="col-md-12">
      ...
      methods: {
        searchInventory: function(page = 1){
          this.userid = this.$gate.Userprofile();
            ...
            this.searchForm.post("api/renterinventory?userid=" + this.userid.renter_id + "&branchid=" + this.branchid.branch_id + "&page=" + page ).then(({ data }) => {
              this.inventory = data;
            });
        }
      },
