<template>
    <div class="container-fluid">
        ...
        <section v-if="$gate.report_is_NOTnull()">
            <div class="row">
                 <div class="col-sm-6">
                      <h3 style="color:#34495e"> SALES HISTORY</h3>
                    </div>
                <div class="col-md-6">
                      <ol class="breadcrumb float-sm-right">
                    ...
                    <form @submit.prevent="searchSales" style="width:100%">
                        ...
                        <div class="col-md-12">
                            <div class="form-group clearfix">
                              ...
                              <br>
                              <downloadexcel class="btn btn-info btn-block export mb-2" style="color:white" :fields = "sales_fields" :fetch="exportData" name="Sales history.xls" type = "csv"><i class="fa fa-download"></i> Download Excel</downloadexcel>
                            </div>
                        </div>
    ...
    export default {
     ...
     components: {
        ...
        methods:{
         ...
         searchSales(page = 1){
              this.searchForm
                    .post("api/reportsaleshistory?page=" + page)
                        .then((data) => {
