<template>
    ...
    <section  v-if="$gate.inventory_null()">
        ...
        <section v-if="$gate.inventory_is_NOTnull()">
             <div class="row">
                 <div class="col-sm-6">
                      <h3 style="color:#34495e"> INVENTORY</h3>
                    </div>
                <div class="col-md-6">
                      <ol class="breadcrumb float-sm-right">
                            ...
                            <div class="form-group clearfix">
                              ...
                              <router-link to="/transactions">
                                <button class="btn btn-info float-sm-right btn-block" style="color:white">
                                   <i class="fa fa-shopping-bag" aria-hidden="true"></i> Transactions
                                  </button>
                                </router-link>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr v-for="(item, i) in inventory.data" :key="item.id ">
                                        ...
                                        <!-- <td>
                                            ...
                                            <button class="btn btn-danger"  @click="deleteProduct(item.id)"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                                        </td> -->
                                    </tr>
                                </tbody>
                            </table>
      ...
      methods:{
        ...
        loadRenters: function() {
          ...
          searchInventory: function(page = 1){
            this.searchForm
                .post("api/searchinventory?page=" + page)
                    .then((data) => {
