    ...
    <div class="container-fluid">
       <section  v-if="$gate.pos_null()">
        ...
        <section v-if="$gate.pos_is_NOTnull()">
             <div class="row">
                 <div class="col-sm-6">
                      <h3 style="color:#34495e"> POS HISTORY</h3>
                    </div>
                <div class="col-md-6">
                      <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><router-link to="/dashboard">Home</router-link></li>
                        <li class="breadcrumb-item active"> POS history </li>
                      </ol>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <form @submit.prevent="searchSaleHistory" style="width:100%">
                        ...
                        <div class="col-md-12">
                            <div class="form-group clearfix">
                                ...
                                <select  id="role" class="form-control" v-model="searchForm.sort" :class="{ 'is-invalid': searchForm.errors.has('sortby') }" name="sort">
                                <option value>Select</option>
                                <option value="reference_no">Invoice #</option>
                                <option value="total_items">Total</option>
     ...
     components: {
        ...
        deleteSelectProduct:function(){
            ...
            searchSaleHistory(page = 1){
                this.searchForm
                    .post("api/searchsalehistory?page=" + page)
                        .then((data) => {
                            this.history = data.data;
                            this.total = data.data.total;
                            this.totalAmount = data.data.totalAmount;
